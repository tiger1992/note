...
public class RegexUtils {
     ...
     * @return
     */
    private static boolean regex(String character, String regex) {
        return character != null && !"".equals(character) && character.matches(regex);
    }

    public static void main(String[] args) {

        boolean flag = regex("23", isDigital);
